...
$route['payment_privacy'] = 'page/payment_privacy';
$route['qna'] = 'page/qna';
...
$route['paymentresponcewallet/(:num)'] = 'page/paytmpaymentresponce/$1';
...
$route['paymentresponce/(:num)'] = 'checkout/paytmpaymentresponce/$1';
$route['ccavenue'] = 'checkout/ccavenue';
$route['thankyou'] = 'checkout/thankyou';
$route['search'] = 'product/search';
$route['network-distribution'] = 'checkout/network_distribution';
...
$route['products/(:any)'] = 'vc_site_admin/profile/real_product';
...
$route['admin/bonanza'] = 'vc_site_admin/order/bonanza_list';
...
$route['admin/stock_detail'] = 'vc_site_admin/sale/stock_detail';
...
$route['admin/history/main_wallet'] = 'vc_site_admin/income/main_wallet_history';
$route['admin/history/reward_point'] = 'vc_site_admin/income/reward_wallet_history';
$route['admin/history/point'] = 'vc_site_admin/income/point_history';
...
$route['admin/income_report'] = 'vc_site_admin/income/income_report'; 
$route['admin/hold/income'] = 'vc_site_admin/income/holdIncome';
...
$route['admin/convert-coin'] = 'vc_site_admin/income/convertCoin';


$route['admin/voucher'] = 'vc_site_admin/profile/voucher'; 
$route['admin/voucher/(:any)'] = 'vc_site_admin/profile/voucher_product'; 
$route['admin/rep_voucher'] = 'vc_site_admin/income/voucher_repurchase';
$route['admin/voucher_order'] = 'vc_site_admin/income/voucher_order';
...
$route['admin/reverse'] = 'vc_site_admin/downlineall/reverse';
$route['admin/reverse/(:any)'] = 'vc_site_admin/downlineall/reverse/$1';
$route['admin/welcomeletter'] = 'vc_site_admin/profile/welcomeletter';
$route['admin/rewards'] = 'vc_site_admin/order/rewards_list';
