...
<table id="example" class="table table-bordered table-hover customer-table"> 
	...
	<thead> <tr><th>ID</th> <th>Coin</th><th>Type</th><th>Status</th><th>Date</th></tr> </thead> 
...
foreach($point_history as $con){ 

	
	echo '<tr><td>'.$i.'</td><td>'.$con['amount'].'</td><td>'.(($con['type'])?$con['type']:"Income").'</td><td>'.$con['status'].'</td><td>'.date('d F Y, g:i a',strtotime($con['rdate'])).'</td>';
