		...
		<div class="form-group col-sm-12">
		 ...
		 <!--  <div class="form-group col-sm-12">
            <label  class="control-label col-sm-3">BV</label>
             <div class="col-sm-9"> <input type="text" required="required" class="form-control"  name="bv" value="<?php if($this->input->post('bv')!='') { echo $this->input->post('bv'); } else { echo $prod['bv']; }  ?>" >
          </div> 
          </div>-->
