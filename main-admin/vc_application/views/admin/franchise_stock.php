				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="x_panel">
						<div class="x_title"> 
						   ...
						   <form class="form form-inline text-right search_product_form" id="search_product_form" action="<?php echo base_url('admin/sale/franchise_stock');?>" method="post" style="float:right;width: 374px;margin-bottom: 16px;">
				...
				<hr class="show-print">			
						   ...
						   <input type="hidden" value="<?php echo implode(',',$selecte_pid);?>" name="pid_array">
								...
								<div class="row">
									...
									<div class="col-md-3 col-xs-12"> &nbsp; Date: <input type="idate" class="form-control datepicker" required id="datepicker" name="idate" value="<?php echo date('m/d/Y');?>" style="width: 120px;display: inline;"> </div>
				...
				<input type="hidden" data="<?php echo $product['id'];?>" name="tbv[]" class="price-count form-control tbv_input_<?php echo $product['id'];?> p_t_bv_input" value="<?php echo $product['comm_dis']; ?>" >
							...
							<hr>
								...
								<div class="row">
								    ...
								    <div class="col-xs-6 col-md-2"><label>Sub Total</label></div>
									<div class="col-xs-6 col-md-2 input-group"><input name="before_tax_amount" type="text" value="<?php echo $grand_total; ?>" class="form-control price_input_total total_input" required onfocus="if (this.value=='0')this.value=''" onblur="if(this.value=='')this.value='0'"></div>
									  <div class="col-xs-6"></div>
								</div>	
								
								<div class="row">
								    <div class="col-xs-6 col-md-2 "><label>Total GST</label></div>
									<div class="col-xs-6 col-md-2 input-group"><input name="total_gst" type="text" value="" class="form-control gst_input_total total_input" required onfocus="if (this.value=='0')this.value=''" onblur="if(this.value=='')this.value='0'"></div>
								<div class="col-xs-6"></div>
								</div>	
								
								<div class="row print-hide">
								    <div class="col-xs-6 col-md-2"><label>Payment Type</label></div>
								...
								<div class="row print-hide">
									...
									<div class="col-xs-6 col-md-2 input-group"><input name="slip_no" placeholder="DD/Neft NO" type="text"  class="form-control"></div>
									<div class="col-xs-6"></div>
								</div>
								
								
								<div class="row print-hide">
								    <div class="col-xs-6 col-md-2"><label>Discount</label></div>
									<div class="col-xs-6 col-md-2 input-group"><input name="discount" type="text" value="<?php echo set_value('discount'); ?>" class="form-control discount_input" required onfocus="if (this.value=='0')this.value=''" onblur="if(this.value=='')this.value='0'"></div>
									<div class="col-xs-6"></div>
								</div>
								...
								<div class="row print-hide hide">
								    ...
								    <div class="col-xs-6 col-md-2"><label>Wallet Transfered</label></div>
									<div class="col-xs-6 col-md-2 input-group"><input name="wallet_credit" type="number"  class="form-control" required value="0"></div>
									<div class="col-xs-6"></div>
								</div>	
								<div class="row print-hide">
								     
								    <div class="col-xs-6 col-md-2"><label>Total BV</label></div>
									<div class="col-xs-6 col-md-2 input-group"><input name="total_bv" class="form-control price_input_bv_total" type="number"  required value="0"></div>
									 <div class="col-xs-6"></div>
								</div>	
								
								<div class="row print-hide">
								    <div class="col-xs-6 col-md-2"><label>Grand Total</label></div>
									<div class="col-xs-6 col-md-2 input-group"><input name="gtotal" type="text" value="<?php echo $grand_total; ?>" class="form-control grand_total_input" required onfocus="if (this.value=='0')this.value=''" onblur="if(this.value=='')this.value='0'"></div>
								  <div class="col-xs-6"></div>
