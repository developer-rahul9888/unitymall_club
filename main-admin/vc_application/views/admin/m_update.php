      ...
      ?>
        ...
        <label  class="control-label col-sm-3">Stock keeping unit(SKU) <small style="color:red">*</small></label>
         ...
         <label  class="control-label col-sm-3">Color</label>
            <div class="col-sm-9">   <select name="color" class="form-control custom-select">
...
<div class="col-sm-12">	 
  ...
  <div class="form-group col-lg-6 col-mg-6 col-sm-6">
		  ...
		  <div class="form-group col-lg-6 col-mg-6 col-sm-6">
            <label  class="control-label col-sm-5">Points</label>
		  ...
		  <div class="form-group col-sm-6">
           <label  class="control-label col-sm-5">Delivery charge</label>
             <div class="col-sm-7"> 
			 <select name="delivery_charge" class="form-control custom-select">
			  <option value="">Yes</option>
			  <option <?php if($prod['delivery_charge']=='no') { echo 'selected="selected"'; } ?> value="no">No</option>
			  </select>
