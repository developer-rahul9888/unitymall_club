				...
				<input type="hidden" data="<?php echo $product['id'];?>" name="tbv[]" class="price-count form-control tbv_input_<?php echo $product['id'];?> p_t_bv_input" value="<?php echo $product['comm_dis']; ?>" >
							...
							<hr>
								...
								<div class="row">
								    ...
								    <div class="col-xs-2"><label>Sub Total</label></div>
								...
								<div class="row">
								    <div class="col-xs-2"><label>Total GST</label></div>
								...
								<div class="row print-hide">
								    <div class="col-xs-2"><label>Payment Type</label></div>
								...
								<div class="row print-hide hide">
								    ...
								    <div class="col-xs-2"><label>Wallet Transfered</label></div>
									<div class="col-xs-2 input-group"><input name="wallet_credit" type="number"  class="form-control" required value="0"></div>
									<div class="col-xs-6"></div>
								</div>	
								<div class="row print-hide">
								     
								    <div class="col-xs-2"><label>Total BV</label></div>
									<div class="col-xs-2 input-group"><input name="total_bv" class="form-control price_input_bv_total" type="number"  required value="0"></div>
									 <div class="col-xs-6"></div>
								</div>	
								
								<div class="row print-hide">
								    <div class="col-xs-2"><label>Grand Total</label></div>
