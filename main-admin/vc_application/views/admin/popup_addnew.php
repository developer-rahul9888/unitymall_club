	 ...
	 //form data
      ...
      echo form_open_multipart(base_url().'admin/popup/add', $attributes);
	  ?>
      <div class="page-heading"> 
        <h2 class="iod">Add Popup images <ul class="list-inline"><li><a class="btn btn-primary btn-sm" href="<?php echo base_url().'admin/popup'; ?>">&laquo; Back</a><li><button type="reset" class="btn btn-primary btn-sm">Reset</button><li><button type="submit" class="btn btn-primary btn-sm">Save</button><li><button type="submit" class="btn btn-primary btn-sm">Save & Continue</button></li></h2>
