 ...
 <?php
      ...
      ?>
	  	...
	  	<div class="col-sm-12">
	  	    ...
	  	    <?php echo form_open('admin/admin_report'); ?>
	...
	<label>To :</label>
		  ...
		  <div class="form-group col-sm-3">
		   ...
		   <?php echo form_open('vc_site_admin/pin/generatecsv_admin'); ?>
...
<thead> <tr> <th>S. No.</th><th>User</th><th>Amount</th><th>Admin(10%)</th><th>Admin</th><th>Pan No.</th><th>Date</th></tr> </thead> 
...
foreach($payouts as $con){  
	...
	echo '<tr><td>'.$i.'</td><td>'.$con['f_name'].' '.$con['l_name'].' ('.$con['customer_id'].')</td><td>'.round($con['amount'],2).'</td><td>10 %</td>
