	 ...
	 //form data
      ...
      echo form_open_multipart('admin/popup/edit/'.$this->uri->segment(4).'', $attributes);
	  $prod = $product[0];
	  ?>
      <div class="page-heading"> 
        <h2 class="iod">Update Popup <ul class="list-inline"><li><a class="btn btn-primary btn-sm" href="<?php echo base_url().'admin/gallery'; ?>">&laquo; Back</a></li><li><button type="submit" class="btn btn-primary btn-sm">Save</button></li><li><button type="submit" class="btn btn-primary btn-sm">Save & Continue</button></li></h2>
      ...
      ?>
		...
		<div class="form-group col-sm-12">
		  ...
		  <div class="form-group col-sm-12">
           <label  class="control-label col-sm-3">Position <small style="color:red">*</small></label>
             <div class="col-sm-9">  <select name="type" class="form-control custom-select">
			  
			  <option <?php if($prod['type']=='homepage') { echo 'selected="selected"'; } ?> value="homepage">Homepage</option>
			  <option <?php if($prod['type']=='dashboard') { echo 'selected="selected"'; } ?> value="dashboard">Dashboard</option>
			  </select>
          </div> 
          </div>
		...
		<input type="hidden" value="<?php echo $prod['image'];?>" name="image_old">
               ...
               <div class="col-sm-7"><?php if($prod['image']!='') { echo '<img width="150" class="img-responsive" src="'.base_url().'images/popup/'.$prod['image'].'" >'; } ?> </div>
          ...
          <div class="form-group">
            <button class="btn btn-primary" type="submit">Save</button> &nbsp; 
			 <a class="btn btn-primary" href="<?php echo base_url().'admin/popup'; ?>">Cancel </a>
          </div>
		  </div>
        </fieldset>
      <?php echo form_close(); ?>
