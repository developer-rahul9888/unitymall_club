	 ...
	 //form data
      ...
      ?>
		...
		<div class="form-group col-sm-12">
		  ...
		  <div class="form-group col-sm-12">
          <label  class="control-label col-sm-7">Aadhar/Driving licence/Voter Card Front Image <small style="color:red"></small></label>
		  <!--input type="hidden" value="<?php //echo $prod['aadharimage']; ?>" name="image_old"-->
             <div class="col-sm-4">   
		   ...
		   <div class="form-group col-sm-12">
			  <label  class="control-label col-sm-7">Aadhar / Driving licence / Voter Card Back Image  <small style="color:red"></small></label>
			  <div class="col-sm-4"> 
		 ...
		 <div class="form-group col-sm-12">
          <label  class="control-label col-sm-7">PAN image <small style="color:red"></small></label>
             <div class="col-sm-4">   
		  ...
		  <div class="form-group col-sm-12">
          <label  class="control-label col-sm-7">Passbook image or cancel cheque <small style="color:red"></small></label>
             <div class="col-sm-4">   
		...
		<h4><strong>Pan card : </strong> <?php echo $prod['pancard'];?>
		...
		<div style="clear:both" class="clearfix"></div>
          <div class="form-group  col-lg-12">
            <button class="btn btn-primary" type="submit">Save</button> &nbsp; 
			 <a class="btn btn-primary" href="<?php echo base_url().'admin/docverification'; ?>">Back </a>
          </div>
